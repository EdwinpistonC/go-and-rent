...
const Reserva = ({ reserva }) => {
    ...
    */
    ...
    return (
        <Paper elevation={6} sx={{ marginBottom: "5px", marginTop: "5px", padding: "0 15px" }}>
                    ...
                    <Grid item xs>
                        <Box>
                            <Grid container direction="row" spacing={2} wrap={"nowrap"}>
                                <Grid item xs>
                                    <Typography><strong>Nombre:</strong> {reserva.guestName}</Typography>
                                </Grid>
                            </Grid>
                            <Grid item xs>
                                <Typography><strong>Alias:</strong> {reserva.guestAlias}</Typography>
                            </Grid>
                            <Grid item xs>
                                <Typography><strong>Contacto:</strong> {reserva.guestPhone}</Typography>
                            </Grid>
                            <Grid item xs>
                                <Typography><strong>Email:</strong> {reserva.guestEmail}</Typography>
                            </Grid>
                        </Box>
                    </Grid>
                    <Grid item xs>
                        <Typography><strong>Período de Reserva</strong></Typography>
                        <Typography>
